    ...
    <form class="form container <?=isset($error_list) && count($error_list) ? 'form--invalid' : ''; ?>" action="sign-up.php" method="post" autocomplete="off"> <!-- form--invalid -->
      ...
      <div class="form__item <?=isset($error_list['name']) ? 'form__item--invalid' : ''; ?>">
        ...
        <span class="form__error"><?=isset($error_list['name']) ? $error_list['name'] : ''; ?></span>
      </div>
