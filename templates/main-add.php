    ...
    <form class="form form--add-lot container <?=count($error_list) ? 'form--invalid' : ''; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        <div class="form__item <?=isset($error_list['lot-name']) ? 'form__item--invalid' : ''; ?>"> <!-- form__item--invalid -->
          ...
          <span class="form__error"><?=isset($error_list['lot-name']) ? $error_list['lot-name'] : ''; ?></span>
        </div>
        <div class="form__item <?=isset($error_list['category']) ? 'form__item--invalid' : ''; ?>">
            ...
            <select id="category" name="category">
                ...
                <?php foreach ($category_list as $val) { ?>
                <option value="<?=isset($val['id_cat']) ? $val['id_cat'] : ''; ?>" <?=isset($new_lot['category']) && isset($val['id_cat']) && $val['id_cat'] === $new_lot['category'] ? 'selected' : ''; ?>>
                  <?=isset($val['name_cat']) ? htmlspecialchars($val['name_cat']) : ''; ?>
                </option>
                <?php } ?>
            </select>
            <span class="form__error"><?=isset($error_list['category']) ? $error_list['category'] : ''; ?></span>
        </div>
      </div>
      <div class="form__item form__item--wide <?=isset($error_list['message']) ? 'form__item--invalid' : ''; ?>">
        ...
        <span class="form__error"><?=isset($error_list['message']) ? $error_list['message'] : ''; ?></span>
      </div>
      <div class="form__item form__item--file <?=isset($error_list['lot-img']) ? 'form__item--invalid' : ''; ?>">
        ...
        <div class="form__input-file">
          ...
          <span class="form__error"><?=isset($error_list['lot-img']) ? $error_list['lot-img'] : ''; ?></span>
          <label for="lot-img">
            Добавить
          </label>
        </div>
      ...
      <div class="form__container-three">
        <div class="form__item form__item--small <?=isset($error_list['lot-rate']) ? 'form__item--invalid' : ''; ?>">
          ...
          <span class="form__error"><?=isset($error_list['lot-rate']) ? $error_list['lot-rate'] : ''; ?></span>
        </div>
        <div class="form__item form__item--small <?=isset($error_list['lot-step']) ? 'form__item--invalid' : ''; ?>">
          ...
          <span class="form__error"><?=isset($error_list['lot-step']) ? $error_list['lot-step'] : ''; ?></span>
        </div>
        <div class="form__item <?=isset($error_list['lot-date']) ? 'form__item--invalid' : ''; ?>">
          ...
          <span class="form__error"><?=isset($error_list['lot-date']) ? $error_list['lot-date'] : ''; ?></span>
        </div>
      </div>
